...
cuda=0
commont="exp_sentiment_binary"
learning_rate=1.7e-5
RAID_BASE_PATH="/raid/user_beatrizalmeida/laqda_results_br_sentiment_analysis"
DATASET_BASE_PATH="datasets-br/sentiment_analysis_remapped"

DATASETS_TO_RUN=("BuscapeCorpus" "KaggleTweetsCorpus" "OlistCorpus")
